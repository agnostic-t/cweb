...
void cweb_box_set_color(cweb_widget *b,
                        cweb_rgb rgb); /* fg + border (legacy) */
void cweb_box_set_bg(cweb_widget *b, cweb_rgb rgb);
void cweb_box_set_border(cweb_widget *b, cweb_border_style style);
void cweb_box_set_border_color(cweb_widget *b, cweb_rgb rgb); /* border only */
void cweb_box_set_border_radius(cweb_widget *b,
                                int px); /* override default; 0 = sharp */
...
void cweb_box_set_font_family(cweb_widget *b,
                              const char *family);   /* e.g. "monospace" */
